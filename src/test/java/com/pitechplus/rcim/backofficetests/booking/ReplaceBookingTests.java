...
public class ReplaceBookingTests extends BackendAbstract {
    ...
    public void replaceBookingTest(BookingCreateDto bookingCreateDto) {
        ...
        BookingDto1 bookingAfterReplace = bookingService.replaceBooking(rcimTestData.getMemberToken(), bookingId,
                bookingCreateDto).getBody();
        newBookingId = bookingAfterReplace.getId().toString();
        
        System.out.println("trtrt "+bookingId);
        //bookingAfterReplace.setId(null);
        //bookingAfterReplace.setFunctionalId(null);
        bookingAfterReplace.getCarSharingInfo().setDelayed(false);
        //bookingAfterReplace.getCarSharingInfo().setCost(null);
    ...
    public void updateBookingTest(BookingCreateDto bookingCreateDto) {
        BookingDto1 bookingAfterReplace = bookingService.updateBooking(rcimTestData.getMemberToken(), bookingId,
                bookingCreateDto).getBody();
        newBookingId = bookingAfterReplace.getId().toString();
