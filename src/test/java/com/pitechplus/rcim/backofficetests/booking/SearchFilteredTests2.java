 ...
 */
public class SearchFilteredTests2 extends BackendAbstract {
    ...
    public void filteredSearchTest() {
        FilteredSearchDto filteredSearchDto = DtoBuilders.buildFilteredSearch(rcimTestData.getMemberLoginEmail(), 
        		rcimTestData.getMemberAutomationParking().getSiteId().toString());
